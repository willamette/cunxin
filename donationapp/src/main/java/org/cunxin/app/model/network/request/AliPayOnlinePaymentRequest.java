...
import org.cunxin.app.alipay.config.AliPayBasicConfig;
import org.cunxin.app.alipay.util.AliPayCoreFunction;
...
public class AliPayOnlinePaymentRequest implements AbstractOnlinePaymentRequest {
    ...
    public void parseParamsNameValuePairs() {
        ...
        sParaTemp.put("_input_charset", AliPayBasicConfig.CHARSET);

        String mysign = AliPayCoreFunction.buildMysign(sParaTemp, _donation.getAliPayPayee().getKey());
        //签名结果与签名方式加入请求提交参数组中
        sParaTemp.put("sign", mysign);
        sParaTemp.put("sign_type", AliPayBasicConfig.SIGN_TYPE);
    ...
    public String getUrl() {
        return AliPayBasicConfig.ALIPAY_GATEWAY_NEW;
    }
